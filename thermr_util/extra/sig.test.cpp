...
TEST_CASE( "compute differential scattering ccross sections" ){
  ...
  GIVEN( "lat = 0" ){
    ...
    WHEN( "temperature is high" ){
      ...
      AND_WHEN( "energy is higher" ){
        ...
        THEN( "sigVal is not set to zero" ){
          ...
          alpha[0] = 1.9;
          sigVal = sig( e, ep, u, tev, tevz, alpha, beta, sab, az, az2, lat, iinc, lasym, cliq, sb, sb2, teff, teff2 );
          REQUIRE( 7.41596058E-2 == Approx( sigVal ).epsilon(1e-6) );
    ...
    WHEN( "150B"){
      ...
      alpha[0] = 1.9;
      sigVal = sig( e, ep, u, tev, tevz, alpha, beta, sab, az, az2, lat, iinc, lasym, cliq, sb, sb2, teff, teff2 );
      REQUIRE( 7.4159605806980167E-002 == Approx( sigVal ).epsilon(1e-6) );
    } // WHEN
    ...
    WHEN( "150C"){
      ...
      alpha[4] = 9.9;
      sigVal = sig( e, ep, u, tev, tevz, alpha, beta, sab, az, az2, lat, iinc, lasym, cliq, sb, sb2, teff, teff2 );
      REQUIRE( 4.159854584E-10 == Approx( sigVal ).epsilon(1e-6) );
    } // WHEN
    ...
    WHEN( "160"){
      ...
      alpha[4] = 9.9;
      sigVal = sig( e, ep, u, tev, tevz, alpha, beta, sab, az, az2, lat, iinc, lasym, cliq, sb, sb2, teff, teff2 );
      REQUIRE( 0.79917055155412087 == Approx( sigVal ).epsilon(1e-6) );
    } // WHEN
