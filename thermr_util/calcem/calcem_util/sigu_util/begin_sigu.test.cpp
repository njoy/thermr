...
#include "../../../../catch.hpp"
#include "begin_sigu.h"


TEST_CASE( "begin sigu (113,116)" ){
  GIVEN( "inputs" ){
  int jbeta = -7, lat = 1, iinc = 2, nemax = 65, 
  ...
  double e = 1.0e-3, ep = 1.2e-4, tev = 1.5e-5, bbm = 0.0, az = 11.9,
    ...
    teff = 6.14e-2, tolin = 5e-2, u, xl = 0, yl = 0, root1 = 2.9e-2;
  ...
  for ( int i = 0; i < alpha.size(); ++i ){
    ...
    do_113_116( jbeta, lat, x, y, e, tev, tevz, root1, u, xl, yl, alpha, beta, 
        sab, bbm, az, lasym, az2, teff, teff2, cliq, sb, sb2, i, iinc);
  ...
  GIVEN( "inputs 2" ){
    ...
    double e = 1.0e-3, ep = 1.2e-4, tev = 1.5e-5, bbm = 0.0, az = 11.9,
      tevz = 2.2e-1, az2 = 0.0, teff2 = 0.0, cliq = 1.0, sb = 5.53, sb2 = 0.0,
      teff = 6.14e-2, tolin = 5e-2, u = 0.05, xl = 0, yl = 0, root1 = 2.9e-2;
