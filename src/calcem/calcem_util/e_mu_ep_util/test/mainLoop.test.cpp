...
TEST_CASE( "E-mu-E' ordering " ){
  ...
  auto scr = mu_ep(eVec,tev,tol,lat,iinc,lasym,alphas,betas,sab,az,sigma_b,sigma_b2,teff);
  std::vector<double> correctSCR { 0, 0, 4.30920E-10, 2.091391E-3, 8.61840E-10, 2.957775E-3, 
...
8.333348E-2, 0.20750076, 9.034799E-2, 0.15923299 };
  ...
  eVec = { 1e-5 };
  scr = mu_ep(eVec,tev,tol,lat,iinc,lasym,alphas,betas,sab,az,sigma_b,sigma_b2,teff);
